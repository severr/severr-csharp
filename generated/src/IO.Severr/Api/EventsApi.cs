...
namespace IO.Severr.Api
{
    ...
    public partial class EventsApi : IEventsApi
    {
        ...
        /// <summary>
        /// Submit an application event or error to Severr The events endpoint submits an application event or an application error / exception with an optional stacktrace field to Severr. 
        /// </summary>
        /// <exception cref="IO.Severr.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="data">Event to submit</param>
        /// <returns></returns>
